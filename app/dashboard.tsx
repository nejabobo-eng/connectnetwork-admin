...
const quickResearchCategories = manualCategories.filter(category => category !== 'Other')
...
export default function Dashboard() {
  ...
  async function queueQuickResearch(category: string) {
    ...
    if (!response.ok) { setMessage(result.error || `Could not queue ${category} product research.`); return }
    await runAutomation()
  }
